...
\begin{center}
\includegraphics[width=.95\textwidth, height=0.8\textheight, keepaspectratio]{0812015.jpg}
\end{center}
}
...
\begin{center}
%\includegraphics[width=6.5cm]{firmware_arch.pdf}
   \includegraphics[width=60mm]{sw_block.pdf}\\
\end{center}
\begin{itemize}
...
\begin{columns}[c]
\column{0.55\textwidth}
 \only<1>{\includegraphics[width=0.95\textwidth]{da15.pdf}}
 \only<2>{\includegraphics[width=0.95\textwidth]{da14.pdf}}
 \only<3>{\includegraphics[width=0.95\textwidth]{da13.pdf}}
 \only<4>{\includegraphics[width=0.95\textwidth]{da12.pdf}}
 \only<5>{\includegraphics[width=0.95\textwidth]{da11.pdf}}
 \only<6>{\includegraphics[width=0.95\textwidth]{da10.pdf}}
 \only<7>{\includegraphics[width=0.95\textwidth]{da09.pdf}}
 \only<8>{\includegraphics[width=0.95\textwidth]{da08.pdf}}
 \only<9>{\includegraphics[width=0.95\textwidth]{da07.pdf}}
\only<10>{\includegraphics[width=0.95\textwidth]{da06.pdf}}
\only<11>{\includegraphics[width=0.95\textwidth]{da05.pdf}}
\only<12>{\includegraphics[width=0.95\textwidth]{da04.pdf}}
\only<13>{\includegraphics[width=0.95\textwidth]{da03.pdf}}
\only<14>{\includegraphics[width=0.95\textwidth]{da02.pdf}}
\only<15>{\includegraphics[width=0.95\textwidth]{da01.pdf}}
\column{0.4\textwidth}
\footnotesize
\begin{itemize}
