...
\begin{frame}{Inside the FPGA: Wishbone}
 \begin{itemize}
	...
	\item We developed a design infrastructure
		\begin{itemize}
		\item scripts to automatically generate Wishbone slave
                  HDL and documentation
		\item IP blocks with descriptors to enable software re-use
		\item support to synthesize and simulate designs with distributed sources
		\item library of Wishbone cores
		\end{itemize}
 \end{itemize}
\end{frame}
