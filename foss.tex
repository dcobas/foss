...
of~\cite{rubini}. Conceptually, it amounts to implementing a bus driver
for the Wishbone bus, plus a PCI-to-Wishbone bridge driver for the
carrier board.
...
all drivers of this family in the kernel. Submission of patches for the
Wishbone bus model to kernel maintainers is imminent.
...
At the time of this writing, beta versions of the framework are in
development~\cite{zio-git}.
