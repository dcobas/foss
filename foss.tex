...
the ANSI VITA~57 FMC standard~\cite{} is described. This kit of boards,
...
interconnects a set of cores providing functionalities that are
common to the whole family of mezzanines, or specific to the application
actually plugged in the FMC slot. We show in figure~\ref{slow-adc}
a typical example of an FPGA application comprising cores for
\begin{Itemize}
...
\end{Itemize}
The net result of this modular FPGA architecture is that 
